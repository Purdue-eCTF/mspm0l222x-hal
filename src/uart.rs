...
use crate::iomux::{InOut, Iomux, PullMode};
    ...
    ($n:literal, $tx_iomux:literal, $rx_iomux:literal, $pf:literal) => {
        ...
        impl ${concat(Uart, $n)} {
            pub fn new(iomux: &Iomux, uart: mspm0l222x_pac::${concat(Uart, $n)}, freq: u32) -> Self {
                ...
                iomux.connect_pin($tx_iomux, $pf, InOut::Output, PullMode::None);
                iomux.connect_pin($rx_iomux, $pf, InOut::Input, PullMode::Up);
...
// On these pins, UART1 uses peripheral function 2.
uart_impl!(1, 19, 20, 2);
impl Uart1 {
